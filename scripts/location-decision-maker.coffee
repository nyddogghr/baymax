...
#
# Commands:
#   hubot remember <location> as a(n) <group> location - Remembers the location for the group
#   hubot forget <location> as a(n) <group> location - Forgets the location from the group
