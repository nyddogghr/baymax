...
module.exports = (robot) ->
  ...
  robot.respond /what is the answer to life, the universe and everything ?/, (res) ->
    unless answer?
  ...
  robot.respond /I am your father/i, (res) ->
    res.send 'Noooooooooooooo !'
    res.send 'http://nooooooooooooooo.com/'
